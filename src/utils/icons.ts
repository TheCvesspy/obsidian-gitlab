/**
 * Icon definitions for the plugin
 */

import { addIcon } from 'obsidian';

// GitLab fox logo simplified for 100x100 viewBox (Obsidian standard)
const GITLAB_LOGO_SVG = `<path fill="currentColor" d="M50 87.5L31.3 30h37.4L50 87.5z"/>
<path fill="currentColor" opacity="0.8" d="M50 87.5L31.3 30H10.5L50 87.5z"/>
<path fill="currentColor" opacity="0.8" d="M50 87.5L68.7 30h20.8L50 87.5z"/>
<path fill="currentColor" opacity="0.6" d="M10.5 30l-7 21.5c-0.6 1.9 0.1 4 1.7 5.2L50 87.5 10.5 30z"/>
<path fill="currentColor" opacity="0.6" d="M89.5 30l7 21.5c0.6 1.9-0.1 4-1.7 5.2L50 87.5 89.5 30z"/>
<path fill="currentColor" opacity="0.4" d="M10.5 30h20.8L22.6 5.8c-0.5-1.5-2.6-1.5-3.1 0L10.5 30z"/>
<path fill="currentColor" opacity="0.4" d="M89.5 30H68.7l8.7-24.2c0.5-1.5 2.6-1.5 3.1 0L89.5 30z"/>`;
...
export const ICONS = {
	...
	gitCommit: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"></circle><line x1="1.05" y1="12" x2="7" y2="12"></line><line x1="17.01" y1="12" x2="22.96" y2="12"></line></svg>`,
	...
	gitMerge: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="18" r="3"></circle><circle cx="6" cy="6" r="3"></circle><path d="M6 21V9a9 9 0 0 0 9 9"></path></svg>`,
...
export function registerIcons(): void {
	addIcon('gitlab-logo', GITLAB_LOGO_SVG);
}

/**
 * Get status icon name for file status
 */
export function getStatusIcon(status: string): string {
	switch (status) {
		...
		case 'conflicted': return 'alert-triangle';
